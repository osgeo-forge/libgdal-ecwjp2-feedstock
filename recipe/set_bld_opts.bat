...
set BLD_OPTS=%WIN64% ^
    ...
    ECW_PLUGIN=YES ^
    ECWDIR=%LIBRARY_PREFIX% ^
    ECWFLAGS="-DECWSDK_VERSION=54 -I%LIBRARY_INC%\ecwjp2 -I%LIBRARY_INC%\ecwjp2\NCSEcw\API -I%LIBRARY_INC%\ecwjp2\NCSEcw\JP2 -I%LIBRARY_INC%\ecwjp2\NCSEcw\ECW" ^
    ECWLIB=%LIBRARY_LIB%\NCSEcw.lib
